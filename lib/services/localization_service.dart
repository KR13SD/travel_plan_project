...
class LocalizationService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'th_TH': {
      ...
      "aiTaskGenerator": "AI Plan Generator",
      "aiTaskGeneratorSubtitle":
          "แปลงข้อความเป็น Plan อัตโนมัติ",
      ...
      "generateWithAI": "สร้าง Plan ด้วย AI",
      "mainTaskInfo": "ข้อมูล Plan หลัก",
      "taskName": "ชื่อ Plan",
      "setMainTaskName": "กำหนดชื่อ Plan หลัก",
      "start": "เริ่ม",
      "end": "สิ้นสุด",
      "subtask": "Sub-task",
    ...
    'en_US': {
      ...
      'ai-import': 'AI-Import',
      'analytics': 'Analytics',
      'ai-task-manager': 'Travel Planner',
      'password': 'Password',
      ...
      "taskName": "Plan Name",
      "setMainTaskName": "Set a main plan name",
      "start": "Start",
      "end": "End",
      "subtask": "Sub-task",
      "noTaskName": "No plan name",
      "noDetails": "No details",
      "subtasksAppearHere": "Plan will appear here",
