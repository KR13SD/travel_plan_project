...
class AiGeneratingOverlay extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isOnAiImportPage = Get.currentRoute.contains('AiImportPage');

    return Obx(() {
      if (!aiCtrl.isGenerating.value &&
          (!aiCtrl.hasResultReady.value || isOnAiImportPage)) {
        return const SizedBox.shrink();
      }

      final bool isGenerating = aiCtrl.isGenerating.value;
